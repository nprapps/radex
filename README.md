...
```
cd radex
mkvirtualenv --no-site-packages radex
...
```
* * * * * ubuntu bash /home/ubuntu/apps/radex/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|radex|tweet|`location`||||
|radex|facebook|`location`||||
|radex|email|`location`||||
|radex|new-comment||||
|radex|open-share-discuss||||
|radex|close-share-discuss||||
|radex|summary-copied||||
|radex|featured-tweet-action|`action`||``tweet_url``|
|radex|featured-facebook-action|`action`||``post_url``|
